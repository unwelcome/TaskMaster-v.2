    ...
    <div class="flex flex-col items-start">
        ...
        <div class="custom-input">
            ...
            <div v-if="inpType === 'password'" class="flex flex-col justify-center cursor-pointer">
                <!--Eye Off-->
                <svg v-if="passwordShowed" @click="togglePassword(false)" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <!--Eye On-->
                <svg v-else @click="togglePassword(true)" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
