<template>
    <div class="flex flex-col items-start">
        ...
        <p v-if="inpShowError">{{ inpError }}</p>
        <p v-if="inpShowDescription">{{ inpDescription }}</p>
    </div>
</template>
<script lang="ts">
export default {
    ...
    watch:{
        inpResetValue(newVal: boolean){
            if(newVal) this.value = this.inpDefaultValue;
        }
    }
}
</script>