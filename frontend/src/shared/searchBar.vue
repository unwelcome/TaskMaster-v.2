<template>
  <div class="bg-bg-input rounded flex flex-row items-stretch overflow-hidden focus">
    <input type="text" class="px-2 py-1 text-lg border-none outline-none bg-transparent grow shrink min-w-0 w-auto" :placeholder="placeholder" v-model="searchValue"/>
